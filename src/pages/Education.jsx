            ...
            <div className='Education'>
              <div className='EducationImage'>
                ...
                <div className='EducationImageOverlay'>
                  ...
                  <h3>Bachelor of Science | Computer Science | Minor in Economics | Concentrations: Intelligence and Info/InterNetworks</h3>
                  <h3>August 2021 - May 2025, Atlanta, GA</h3>
                </div>
              </div>
              <p>GPA: 3.64/4.0</p>
              <p>Relevant Coursework: Machine Learning, Economic/Financial Valuation, Database Management, Artificial Intelligence, Data Structures and Algorithms, Object Oriented Programming, Agile Development, Probability and Statistics, Econometric Analysis</p>
